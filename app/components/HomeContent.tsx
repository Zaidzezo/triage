    ...
    <motion.div
      ...
      style={{
        ...
        border:
          `1px solid ${T.border}`,
        background:
          "linear-gradient(145deg, rgba(22,26,37,0.72), rgba(10,13,20,0.72))",
      }}
    >
      <div
        style={{
    ...
    <div
      style={{
        ...
        border:
          `1px solid ${T.border}`,
        background:
          "linear-gradient(145deg, rgba(23,27,40,0.76), rgba(9,12,18,0.76))",
        boxShadow:
...
export default function HomeContent() {
  ...
  useEffect(() => {
    ...
    // intentional first-load behavior
  ...
  async function fetchIssues(
    ...
    try {
      ...
      /* Preserve any scores already in API response */
  ...
  /* ───────────────────────
     ...
     THIS is where availableLanguages
     is calculated.
  ─────────────────────── */
  ...
  const hasResults =
    issuesWithScores.length >
    0;

  const isGlobalSearch =
    issuesWithScores.some(
      (issue) =>
        !!issue.repo
    ) &&
    new Set(
      issuesWithScores.map(
        (issue) =>
          issue.repo
            ?.fullName
      )
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              by repository quality,
              technology, freshness,
              and contribution fit.
            </p>
                ...
                style={{
                  ...
                  opacity:
                    isLoading
                      ...
                      : 1,
                  boxShadow:
                    "0 14px 38px rgba(155,140,255,0.20)",
                  whiteSpace:
                    "nowrap",
                }}
              >
              ...
              <div
                style={{
                  ...
                  borderRadius:
                    11,
                  background:
                    "rgba(255,142,158,0.08)",
                  border:
                    "1px solid rgba(255,142,158,0.22)",
                  color:
                    T.red,
                  fontSize:
                    12,
        ...
        >
          ...
          >
            {/* STEP 7/8 CONNECTION:
                availableLanguages is passed here. */}
